      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-slate-800 text-lg">Màu Picker From TP</h1>
              <p className="text-xs text-slate-500 font-medium"> Công cụ pick màu đỉnh nhất quả đất </p>
            </div>
          </div>
